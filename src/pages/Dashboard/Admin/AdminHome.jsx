...
const AdminHome = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axiosSecure.get(`/admin-profile/${user.email}`);
    ...
    return (
        ...
        <div className="flex my-8 lg:ml-[350px] flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-900 dark:text-gray-100">
            <img src={admin.photo} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
            <div className="space-y-4 text-center divide-y dark:divide-gray-700">
                <div className="my-2 space-y-1">
                    <h2 className="text-xl font-semibold sm:text-2xl">{admin.name}</h2>
                    <p className="px-5 text-xs sm:text-base dark:text-gray-400">Healthcare Admin </p>
                    <p className="px-5 text-xs sm:text-base dark:text-gray-400">{admin.email}</p>
                </div>
