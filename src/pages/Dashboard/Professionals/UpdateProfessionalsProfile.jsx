...
const UpdateProfessionalsProfile = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (res.data.success) {
            ...
            const doctorRes = await axiosSecure.patch(`/doctorprofile-update/${user.email}`, doctordata)
            console.log(doctorRes.data);
            if (doctorRes.data.acknowledged == true) {
                reset()
                Swal.fire({
                    position: "top-end",
                    icon: "success",
        ...
        <div className="ml-8 mb-20 bg-gray-100 p-20  rounded-xl">
            <form onSubmit={handleSubmit(onSubmit)} className="">
                ...
                <div>
                    ...
                    <input {...register("number")} type="text" placeholder="Contact Number" className="input input-bordered w-[700px] " required />
                ...
                <div className="form-control w-[700px]">
                    <label className="label">
                        <span className="label-text">Specialize Area</span>

                    </label>
                    <textarea {...register("specialist")} className="textarea textarea-bordered h-24" placeholder="Interests Area" required></textarea>
                </div>
...
export default UpdateProfessionalsProfile;